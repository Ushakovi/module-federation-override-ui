...
export const ModuleDialog = (props: IProps) => {
    ...
    const handleSubmit = (evt: h.JSX.TargetedEvent<HTMLFormElement, Event>) => {
        ...
        if (
            module &&
            module.moduleName &&
            getModuleIsDisabled(module.moduleName)
        ) {
    ...
    const isCanDisableOverride =
        module && module.overrideUrl && !module.disabled;
                            ...
                            <tr>
                                ...
                                <td style={{ position: 'relative' }}>
                                    <input
                                        ...
                                        tabIndex={2}
                                        onInput={(evt: any) =>
                                            setOverrideUrl(evt.target.value)
                                        }
                                    />
                                    <div
                                        role='button'
